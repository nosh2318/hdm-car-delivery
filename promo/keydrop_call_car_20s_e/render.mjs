...
const output = path.join(root, 'KEYDROP_常時ロゴ_女性ソロ旅_20sec.mp4');
const parts = [];
...
photo('02-road.mp4', '01-coast-drive.png', 3.2, [
  ...
  `drawtext=fontfile='${jp}':text='ひとり旅が、自由になる。':fontsize=46:fontcolor=white:x=350:y=52`,
...
photo('05-hokkaido.mp4', '04-hokkaido-drive.png', 3.2, [
  ...
  `drawtext=fontfile='${jp}':text='自分だけの、次の景色へ。':fontsize=68:fontcolor=0x111111:x=68:y=225`,
].join(','));
