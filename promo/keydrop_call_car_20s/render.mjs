...
const output = path.join(root, 'KEYDROP_車で遊ぼう_呼ぶレンタカー_20sec.mp4');
...
const scenes = [
  { image: '04-drive.png', duration: 2.8, main: '車で、遊ぼう。', sub: '移動の時間まで、旅のハイライトに。', pan: 'left', accent: '0xFFC400', shout: 'PLAY THE ROAD' },
  { image: '01-map-live.png', duration: 2.8, main: '地図から、呼ぶ。', sub: '「ここに来て」をタップ。', pan: 'right', accent: '0xFFC400', shout: 'CALL YOUR CAR' },
  { image: '02-key-scooter.png', duration: 3.0, main: '車が、届く。', sub: 'スタッフが指定場所へ。', pan: 'left', accent: '0xFFC400', shout: 'CAR DELIVERY' },
  { image: '03-scooter-exit.png', duration: 3.0, main: '会ったら、走る。', sub: '位置を共有して、スマートに合流。', pan: 'right', accent: '0xFFC400', shout: 'MEET & GO' },
  { image: '04-drive.png', duration: 3.6, main: '好きな場所から。', sub: '新しい、呼ぶレンタカー。', pan: 'left', accent: '0xFFC400', shout: 'KEYDROP' },
];
